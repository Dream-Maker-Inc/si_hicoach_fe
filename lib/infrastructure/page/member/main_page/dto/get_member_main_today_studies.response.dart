...
part 'get_member_main_today_studies.response.g.dart';

@JsonSerializable()
class GetMemberMainTodayStudiesResponse extends BaseResponse<List<Data>> {
  ...
  factory GetMemberMainTodayStudiesResponse.fromJson(
          Map<String, dynamic> json) =>
      _$GetMemberMainTodayStudiesResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$GetMemberMainTodayStudiesResponseToJson(this);
}
